...
/**
 * Kuuntelee näppäimistöstä tulevia painalluksia, sekä näppäimen vapautuksia,
 * sekä asettaa nille toiminnot
 *
 * @author Joonas
 */
public class NappaimistonKuuntelija implements KeyListener {
    ...
    /**
     * Konstruktori saa parametrinaan laudat.
     *
     * @param lautaVasen
     * @param lautaOikea
     */
    ...
    /**
     * Painaessa näppäin alas, asettaa metodi sitä näppäintä vastaavan suunnan
     * arvoksi true ja vastakkaisen suunnan false
     *
     * @param ke
     */
    @Override
    ...
    /**
     * Kun näppäin vapautetaan, metodi asettaa sitä vastaavan suunnan arvoksi
     * false
     *
     * @param ke
     */
